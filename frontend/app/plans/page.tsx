    ...
    <div className="min-h-screen bg-gray-50">
      <div className="bg-white border-b">
        <div className="max-w-4xl mx-auto px-4 py-3 flex items-center gap-3">
          ...
          <h1 className="text-lg font-bold text-gray-900">我的行程</h1>
        </div>
      </div>
        ...
        {loading ? (
          <div className="space-y-3">
            {Array.from({ length: 3 }).map((_, i) => (
              <div key={i} className="bg-white rounded-lg border p-4 animate-pulse space-y-2">
          ...
          <div className="text-center py-16">
            ...
            <p className="text-gray-400 text-sm mb-1">暂无行程</p>
                  ...
                  <div className="flex items-start justify-between">
                    <div className="flex-1 min-w-0">
                      <div className="flex items-center gap-2">
                        <h3 className="font-medium text-gray-900">{plan.destination}</h3>
